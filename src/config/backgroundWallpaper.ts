...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: {
				// 桌面端要显示的来源文本
				desktop: "纯白交响曲SANA EDITION - Palette",
				// 移动端要显示的来源文本
				mobile: "纯白交响曲SANA EDITION - Palette",
			},
			url: {
				// 桌面端原始艺术品或艺术家页面的 URL 链接
				desktop: "https://palette.clearrave.co.jp/product/mashiro-project/mashiro/",
				// 移动端原始艺术品或艺术家页面的 URL 链接
				mobile: "https://palette.clearrave.co.jp/product/mashiro-project/mashiro/",
			},
		},
		// 横幅导航栏配置
		navbar: {
