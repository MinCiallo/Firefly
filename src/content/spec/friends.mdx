...
export const site = {
  name: "MinCiallo",
  desc: "愿千年之恋，有朝一日能使万花绽放",
  url: "https://www.minciallo.top",
  avatar: "https://cdn.jsdelivr.net/gh/MinCiallo/Repository@main/avatar.avif",
  email: "admin@minciallo.top",
};
    ...
    <div class="rounded-2xl border border-(--line-divider) overflow-hidden flex flex-col">
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          {/* 申请按钮 */}
          <div class="flex gap-3.5 mt-4 pt-4 border-t border-(--line-divider)">
            <div class="w-7 shrink-0"></div>
            <div>
              <a
                href="https://github.com/MinCiallo/Firefly/issues/new?template=04-friend_link.yml"
                target="_blank"
                rel="noopener noreferrer"
                class="!text-white !bg-(--primary) hover:opacity-85 transition text-sm font-medium inline-flex items-center gap-2 px-4 py-2 rounded-lg"
              >
